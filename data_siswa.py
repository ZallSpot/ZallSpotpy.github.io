...
class Data_Siswa(Tk):
    def __init__(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Tidak dapat terhubung ke database: {e}")
            self.destroy()
            return
    ...
    def update_data(self):
        ...
        # Bersihkan form sebelum menambahkan data update
        self.nis_entry.delete(0, END)
        self.nama_entry.delete(0, END)
        self.jurusan_entry.delete(0, END)
        self.alamat_entry.delete("1.0", END)

        # Tampilkan data terpilih di form
        ...
        self.update_button = Button(self, text="Update", command=lambda: self.proses_update(data[0]))
    ...
    def proses_update(self, nis_to_update):
        ...
        # Hapus tombol update setelah proses selesai
